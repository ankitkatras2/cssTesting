...
@Component({
  selector: 'app-pure-css-nav-bar1',
  templateUrl: './pure-css-nav-bar1.component.html',
  styleUrls: ['./pure-css-nav-bar1.component.css']
})
export class PureCssNavBar1Component implements OnInit {
  cssCode: string;
  htmlCode: string;
  jsCode: string;
  ...
  .item:target .subMenu {
    ...
    `;
    this.htmlCode = `<div class="wrapper">
    <ul class="mainMenu">
