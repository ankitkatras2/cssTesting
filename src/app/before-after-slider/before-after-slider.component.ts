...
<html lang="en" >
  <head>
    <meta charset="UTF-8">
    <title>After Before Slider | Wevdevtrick.com</title>
...
function beforeAfter() {
  ...
  public loadScript() {
    ...
    if (!isFound) {
      var dynamicScripts = [environment.url + "js/beforeAfterSlider.js"];
      // var dynamicScripts = ["../../cssTesting/assets/js/beforeAfterSlider.js"];
